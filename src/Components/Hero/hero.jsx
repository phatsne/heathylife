  ...
  return (
    <Container className="my-5">
        ...
        <Row className="gy-4">
            <Col md={4}>
            <Card>
                <Card.Img variant="top" src="https://via.placeholder.com/300x200" alt="Yoga 1" />
                <Card.Body>
                ...
                <Button variant="danger">Tìm Hiểu Thêm</Button>
                </Card.Body>
            </Card>
            </Col>
            ...
            <Col md={4}>
            <Card>
                <Card.Img variant="top" src="https://via.placeholder.com/300x200" alt="Yoga 2" />
                <Card.Body>
            ...
            <Col md={4}>
            <Card>
                <Card.Img variant="top" src="https://via.placeholder.com/300x200" alt="Yoga 3" />
                <Card.Body>
